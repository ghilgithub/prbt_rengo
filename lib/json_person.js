    ...
    $.getJSON('output2.json', function(allHdata){
      ...
      */
      ...
      $.each(hDataArray, function(index, elem) {
        ...
        if (elem.タイトル != '') {
          var titleLabel = 'up';
          if ( elem.結果_タイトル == '1位' || elem.結果_タイトル == '1位🏆' || elem.結果_タイトル == '2位' || elem.結果_タイトル == '3位' || elem.結果_タイトル == '通過' ) {
            titleLabel = 'up';
        ...
        } else if (elem.結果_試験 == '1ランク昇格' || elem.結果_試験 == '2ランク昇格' || elem.結果_試験 == '4ランク昇格' || elem.結果_試験 == '一つ前進' || elem.結果_試験 == '二つ前進') {
